...
@router.post("/search/hbase", response_model=SearchResponseDTO)
def search_hbase(
    query: str | None = Query(
        None, description="Search query (required for some types)"),
    search_type: str = Query(
        "keyword", description="Search type: keyword, author, venue, paper, institution, top_authors, trending, paper_stats"),
